...
# tensors = load_file("/workspace/training_sdxl/astria_training/checkpoint/unet/checkpoint-3000.lora.safetensors")
...
# handler.load_embeddings("/workspace/training_sdxl/astria_training/checkpoint/embeddings/checkpoint-3000.pti")
...
prompt = "a <s0><s1> woman doing sexy pose, front view, luxurious bedroom, behind her is a window and snowy forest"
